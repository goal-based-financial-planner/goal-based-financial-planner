# SECURITY.md Template Contract

**Purpose**: Define security vulnerability reporting process
**Target File**: `/SECURITY.md` (new file)
...
- [ ] GitHub Security Advisories prominently featured as primary reporting channel
- [ ] Response SLA clearly stated (48 hours acknowledgment, 5 days assessment)
- [ ] Supported versions table accurate
- [ ] Security scope appropriate for frontend-only app
- [ ] Disclosure policy included
- [ ] User best practices section included
- [ ] All GitHub URLs correct (org and repo names)
- [ ] Contact information clear (Security Advisories for vulnerabilities, Discussions for questions)
- [ ] Tone is professional and encouraging (thank reporters)
- [ ] No sensitive information disclosed in template
